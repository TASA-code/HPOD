...
Vector3d AccelMod(Vector6d r_GCRF, double mu, int n_max, 
              int m_max, double R_ref, double time)
{
	...
	Vector3d r_bf;				/* Body-fixed position */
	Vector3d a_bf;				/* Body-fixed acceleration */
    Vector6d ITRF;
	...
	********************************/
	...
	a_bf[0] = (mu/(R_ref * R_ref)) * ax;
	a_bf[1] = (mu/(R_ref * R_ref)) * ay; 
	a_bf[2] = (mu/(R_ref * R_ref)) * az;
